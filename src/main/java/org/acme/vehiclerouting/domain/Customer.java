...
public class Customer {
    ...
    public long getServiceFinishedDelayInMinutes() {
        ...
        return Duration.between(dueTime, arrivalTime.plus(serviceDuration)).toSeconds();
    }
    ...
    public String toString() {
        ...
        if (arrivalTime != null) {
            ...
            int arrivalTimeInt = (int) Duration.between(vehicle.getDepartureTime(), arrivalTime).toSeconds();

            return "Customer-" + id
                    + "\ttravel: " + getDrivingTimeSecondsFromPreviousStandstill()
                    + "\tarrival: " + (arrivalTime.getMinute() * 60 + arrivalTime.getSecond())
                    + "\tdeparture: " + (getDepartureTime().getMinute() * 60 + getDepartureTime().getSecond())
//                    + "\tservice: " + serviceDuration.toString()
                    + "\tdue time: " + (dueTime.getMinute() * 60 + dueTime.getSecond())
                    + "\tdelay: " + this.getServiceFinishedDelayInMinutes();
